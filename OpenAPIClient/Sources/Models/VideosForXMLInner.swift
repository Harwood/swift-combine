...
public struct VideosForXMLInner: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        mediacategory = try container.decodeIfPresent(Int.self, forKey: .mediacategory)
        mediacommunity = try container.decodeIfPresent(VideosForXMLInnerMediaCommunity.self, forKey: .mediacommunity)
        mediaembed = try container.decodeIfPresent(VideosForXMLInnerMediaEmbed.self, forKey: .mediaembed)
        mediaplayer = try container.decodeIfPresent(VideosForXMLInnerMediaPlayer.self, forKey: .mediaplayer)
        mediathumbnail = try container.decodeIfPresent(VideosForXMLInnerMediaThumbnail.self, forKey: .mediathumbnail)
        mediatitle = try container.decodeIfPresent(String.self, forKey: .mediatitle)
        mediadescription = try container.decodeIfPresent(String.self, forKey: .mediadescription)
        mediarating = try container.decodeIfPresent(Mediarating.self, forKey: .mediarating)
        enclosure = try container.decodeIfPresent(VideosForXMLInnerEnclosure.self, forKey: .enclosure)
        mediagroup = try container.decodeIfPresent([VideosForXMLInnerMediaGroupInner].self, forKey: .mediagroup)
    }
