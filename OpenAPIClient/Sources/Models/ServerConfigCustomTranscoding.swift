...
public struct ServerConfigCustomTranscoding: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        allowAdditionalExtensions = try container.decodeIfPresent(Bool.self, forKey: .allowAdditionalExtensions)
        allowAudioFiles = try container.decodeIfPresent(Bool.self, forKey: .allowAudioFiles)
        threads = try container.decodeIfPresent(Int.self, forKey: .threads)
        concurrency = try container.decodeIfPresent(Double.self, forKey: .concurrency)
        profile = try container.decodeIfPresent(Profile.self, forKey: .profile)
        resolutions = try container.decodeIfPresent(ServerConfigCustomTranscodingResolutions.self, forKey: .resolutions)
        webVideos = try container.decodeIfPresent(ServerConfigCustomTranscodingWebVideos.self, forKey: .webVideos)
        hls = try container.decodeIfPresent(ServerConfigCustomTranscodingHls.self, forKey: .hls)
    }
