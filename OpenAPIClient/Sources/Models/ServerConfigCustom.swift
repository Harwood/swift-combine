...
public struct ServerConfigCustom: Codable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        instance = try container.decodeIfPresent(ServerConfigCustomInstance.self, forKey: .instance)
        theme = try container.decodeIfPresent(ServerConfigCustomTheme.self, forKey: .theme)
        services = try container.decodeIfPresent(ServerConfigCustomServices.self, forKey: .services)
        cache = try container.decodeIfPresent(ServerConfigCustomCache.self, forKey: .cache)
        signup = try container.decodeIfPresent(ServerConfigCustomSignup.self, forKey: .signup)
        admin = try container.decodeIfPresent(ServerConfigCustomAdmin.self, forKey: .admin)
        contactForm = try container.decodeIfPresent(ServerConfigEmail.self, forKey: .contactForm)
        user = try container.decodeIfPresent(ServerConfigCustomUser.self, forKey: .user)
        transcoding = try container.decodeIfPresent(ServerConfigCustomTranscoding.self, forKey: .transcoding)
        _import = try container.decodeIfPresent(ServerConfigCustomImport.self, forKey: ._import)
        autoBlacklist = try container.decodeIfPresent(ServerConfigAutoBlacklist.self, forKey: .autoBlacklist)
        followers = try container.decodeIfPresent(ServerConfigCustomFollowers.self, forKey: .followers)
    }
